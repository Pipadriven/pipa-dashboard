...
export interface VisaoGeral {
  // Confirmado contra a fn_visao_geral em 21/09/2026: as contagens voltam
  // NULL, não 0, quando não há linha no período. Tratar como number puro
  // quebraria em toLocaleString.
  leads: number | null;
  ...
  leads_midia: number | null;
  leads_rede: number | null;
