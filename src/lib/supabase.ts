...
// Configuração por ambiente. Os valores abaixo são o fallback do projeto atual,
// para que builds sem .env continuem funcionando.
const SUPABASE_URL =
  import.meta.env.VITE_SUPABASE_URL ?? "https://dobbjbvqgvnhmvoxhtjk.supabase.co";
